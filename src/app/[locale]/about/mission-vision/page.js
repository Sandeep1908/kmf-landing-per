          ...
          <div className="w-full flex flex-col justify-center items-start shadow-md ">
            ...
            <ul className="flex flex-col space-y-3 p-6 w-full h-full justify-center items-center list-disc text-justify text-lg  md:justify-normal md:items-start">
              ...
              {locale === 'en'
                ...
                ಮತ್ತು ಕರ್ನಾಟಕ ರಾಜ್ಯದ ಅತ್ಯಂತ ಲಾಭದಾಯಕ ಡೇರಿ ರೈತರ ಸಂಸ್ಥೆ..`}
              ...
              {locale === 'en'
                  ...
                  ವಿಶ್ವಬ್ಯಾಂಕ್ ನೆರವಿನ ಡೇರಿ ಅಭಿವೃದ್ಧಿಯನ್ನು ಕಾರ್ಯಗತಗೊಳಿಸಲು 1975 ರಲ್ಲಿ ಏಜೆನ್ಸಿಯಾಗಿ
                  ಯೋಜನೆಗಳು,ಕರ್ನಾಟಕ ಡೇರಿ ಡೆವಲಪ್ಮೆಂಟ್ ಕಾರ್ಪೊರೇಶನ್ (ಕೆಡಿಡಿಸಿ) ರಚನೆಯಾಯಿತು, ಕಂಪನಿಯು ಬೆಳೆಯಿತು
                  ...
                  ಡೇರಿ ಚಟುವಟಿಕೆಯ ವಿವಿಧ ನಿಯತಾಂಕಗಳನ್ನು ಕಾರ್ಯಗತಗೊಳಿಸುವುದು - ಡೇರಿ ಸಂಘಟನೆ
              ...
              {locale === 'en'
                  ...
                  ಡೇರಿ ಸಹಕಾರ ಸಂಘಗಳು. ಕರ್ನಾಟಕದ ಎಂಟು ದಕ್ಷಿಣ ಜಿಲ್ಲೆಗಳನ್ನು ಪರಿಗಣಿಸಲಾಗಿದೆ
                  ಆರಂಭದಲ್ಲಿ 1800 ಡೇರಿ ಸಹಕಾರ ಸಂಘಗಳು, ನಾಲ್ಕು ಹಾಲು ಸಂಘಟಿಸುವ ಗುರಿಯೊಂದಿಗೆ
              ...
              {locale === 'en'
                  ...
                  ಸಹಕಾರ ಸಂಘಗಳು. ಸಂಸ್ಕರಣಾ ಸೌಲಭ್ಯಗಳು ಅಂದರೆ ಶೀತಲೀಕರಣ ಕೇಂದ್ರಗಳು, ಹಾಲಿನ ಡೇರಿಗಳು
