      ...
      <div className="pdf-preview-options flex flex-col justify-center items-center text-sm gap-2">
        <div className="flex">
          ...
          <div className="flex justify-center items-center space-x-3">
            <button
              className="text-sm  rounded-full w-5 h-5 flex items-center justify-center cursor-pointer bg-primary-gradient p-1 text-white  "
        ...
        <div className="flex justify-center items-center space-x-3 m-2 ">
          <button
            className="text-sm  cursor-pointer bg-primary-gradient p-2 text-white  "
