...
const HistoryOfMilk = () => {
  return (
    ...
    <div className='w-full h-auto'>
        ...
        <h1 className='text-primary-main text-2xl md:text-6xl ' style={{fontFamily:'cursive'}}> <i> HISTORY OF MILK </i></h1>
        <div className='p-6 lg:p-28 text-center ' >
                  


                < p className='text-lg'>The history of milk is a fascinating journey that intertwines with the evolution of human civilization and the domestication of animals. As early humans transitioned from a nomadic lifestyle to settled agricultural communities, the realization that certain animals could provide a steady supply of milk marked a pivotal moment.
                  
             The domestication of animals like cows, goats, and sheep was a transformative development. These animals not only provided meat and hides but also became a reliable source of milk. This discovery had profound implications for human nutrition, allowing communities to </p> <br />
                <p className='text-lg'>Ancient civilizations, from Mesopotamia to Egypt and the Indus Valley, embraced dairy farming. In Sumeria, the goddess Ninhursag was revered as the goddess of milk, emphasizing the cultural and symbolic importance attached to this nutritious substance. Similarly, Egyptian art depicted scenes of milking and dairy processing, showcasing the centrality of milk in their daily lives.</p>
                  
              </div>
                    

        </div>
        <div className='w-full h-[600px] md:h-[1000px] lg:h-[500px] flex flex-col lg:flex-row items-center'>
               <div className='relative w-[100%] lg:w-[50%] h-[50%] lg:h-full bg-[#f99457] flex flex-col justify-between p-6 md:p-20'>
                <div className='absolute w-full h-full top-0 left-0 z-20'>
                     <img className='w-full h-full opacity-0 transition duration-0 hover:opacity-30 hover:duration-1000 ' src={founderOfMilkImg.src} alt="" />
                </div>
                <div className=' w-full h-full z-50'>
                <h1 className='text-white text-xl md:text-4xl '>KSHEERA PITHAMHA - DR. VERGHESE KURIEN
                        </h1>
                        <p className='mt-4 md:mt-8 text-lg text-white'>Dr. Verghese Kurien, the Father of the White Revolution, passed away...</p>
                </div>
                 
                        <div className=' w-28 h-7 md:w-40 md:h-14 border-[1px] border-white '>
                            <div className='w-full h-full flex justify-center items-center border-l-[3px] border-l-white hover:border-[3px] hover:duration-200 '> 
                              <p className='text-sm md:text-lg  text-white'>Know More</p>
                            </div>
                        </div>
               </div>
               <div className='relative w-[100%] lg:w-[50%] h-[50%] lg:h-full bg-[#4f7ffc] '>
               <div className='absolute w-full h-full top-0 left-0 z-20'>
                     <img className='w-full h-full opacity-0 transition duration-0 hover:opacity-30 hover:duration-1000 ' src={KRISHNAPPA.src} alt="" />
                </div>
                <div className='full h-full flex flex-col justify-between p-6 md:p-20 ' >
                <div className='w-full h-full z-50'>
                <h1 className='text-white text-xl md:text-4xl '> KSHEERA BRAHMA - MR. MV KRISHNAPPA
                        </h1> 
...
//             <h1 className='text-primary-main text-2xl md:text-6xl'>HISTORY OF MILK</h1>
//             <div className='bg-primary-main w-72 h-1 mt-4'></div>
...
//             <h1 className='text-primary-main text-2xl md:text-5xl text-center'>KSHEERA PITHAMHA - DR. VERGHESE KURIEN
// </h1>
//             <div className='bg-primary-main w-72 h-1 mt-4'></div>
...
//                     {/*  */}
//                 </div>
//                 <div className='order-1 md:order-last max-w-[100%] md:max-w-[50%] flex items-center' > 
//                 <img className='w-full' src={founderOfMilkImg.src} alt="" />
//                 </div>
//             </div>
...
//     <div id='Ksheera' className='w-full mt-20 md:mt-36'>
...
//                 </div>
//                 <div className='order-1 md:order-last max-w-[100%] md:max-w-[50%] flex items-center' > 
//                 <img className='w-full'  src={historyImg.src} alt="" />
//                 </div>
