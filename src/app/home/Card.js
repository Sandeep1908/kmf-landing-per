...
function Card({ imgUrl, title, description }) {
  ...
  return (
      ...
      <div
        className=" max-w-[450px]  h-[480px] bg-light-light4 rounded-md overflow-hidden   m-auto"
...
export const LinkCard = ({ imgUrl, title, description }) => {
  return (
    <div className=" ">
      <div
        className="p-2 w-[250px] h-[250px] flex justify-center items-center border-neutral-dark1   bg-neutral-light4 rounded-full"
        style={{ boxShadow: '0px 8px 24px 0px rgba(0, 0, 0, 0.12)' }}>
        <img
          src={imgUrl}
          alt="featured-img"
          className=" w-[120px] h-[120px] object-contain hover:rotate-45 "
          style={{ transition: '.4s all' }}
        />
      </div>
